...
CREATE TABLE `singlegrade` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=77 DEFAULT CHARSET=latin1 COMMENT='单工种成绩表';
...
-- Records for `notice`
-- ----------------------------
INSERT INTO `notice` VALUES ('1', '测试', '<p>奥德赛</p><p style="text-align: center;">啊实打实</p><p><strong>撒旦</strong></p>', '1501506451');
...
-- ----------------------------
INSERT INTO `totalmark` VALUES ('1', '1', '201330092001', '陈秋华', '115', '73', '80', '103');
INSERT INTO `totalmark` VALUES ('2', '2', '201330092015', '郝顺章', '117', '65', '85', '103');
