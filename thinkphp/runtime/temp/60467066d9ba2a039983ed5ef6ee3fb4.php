<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"D:\UPUPW_AP5.6\htdocs\kind\thinkphp\public/../application/index\view\shuaige\template.html";i:1502887410;}*/ ?>
                ...
                <tbody>
                  <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                      ...
                      <td><a href="<?php echo url('index/shuaige/dataout'); ?>?id=<?php echo $vo['id']; ?>"><button class="btn btn-success btn-sm pull-left">导出单科成绩模板</button></a></td>
                    </tr>
