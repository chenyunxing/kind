<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\UPUPW_AP5.6\htdocs\kind\thinkphp\public/../application/index\view\shuaige\index.html";i:1505978921;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <script src="__ROOT__/static/js/common.js?q=2"></script>
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li id="ajax12" ajax="changeown"><p>修改单科成绩</p></li>
